                ...
                <div className="flex-1 flex items-start md:justify-end gap-20">
                    <div>
                        ...
                        <ul className="text-sm space-y-2 text-white font-semibold ">
                            ...
                            <li className="hover:text-slate-300 transition-all duration-300 "><a href="/analyse">Analyses</a></li>
                            <li className="hover:text-slate-300 transition-all duration-300 "><a href="/Predictions">Prédictions</a></li>
                            <li className="hover:text-slate-300 transition-all duration-300 "><a href="/consignes">Consignes</a></li>
                        </ul>
                    </div>
                    <div>
